public static class BattleSessionData
{
    ...
    public static void SetSession(CharacterData player, EnemyData[] enemies, string returnScene, string victoryFlag = null, SubObjectiveData victorySubObjective = null)
    {
